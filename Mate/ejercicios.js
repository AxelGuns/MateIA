 ...
 function mostrarFeedback(esCorrecta) {
    ...
    if (esCorrecta) {
        ...
        if (typeof verificarNivel === 'function') {
            ...
            if (typeof actualizarRachaDiaria === 'function') {
                actualizarRachaDiaria();
            }

            // ✅ Incrementar contador de ejercicios completados
            let ejerciciosHechos = parseInt(localStorage.getItem("mateia_ejercicios_completados")) || 0;
            localStorage.setItem("mateia_ejercicios_completados", ejerciciosHechos + 1);

            // ✅ Re-verifica insignias para desbloqueos inmediatos
            if (typeof verificarInsignias === 'function') {
                verificarInsignias();
            }
        }
